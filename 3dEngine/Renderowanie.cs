            ...
            for (int y = (int)y0.Y; y <= y1.Y; ++y)
            {
                ...
                for (int x = (int)x0.X + 1; x <= x1.X; ++x)
                {
                    ...
                    if(teksturaKolory == null)
                    {
                        ...
                        {
                            Red = (byte)(127 * jasnosc),
                            Green = (byte)(127 * jasnosc),
                            Blue = (byte)(127 * jasnosc),
                        });
                    ...
                    var c = new Color()
                    {
                        Red = (byte)((db * (da * kolorP1.Red + a * kolorP3.Red) + b * (da * kolorP2.Red + a * kolorP4.Red)) * jasnosc),
                        Green = (byte)((db * (da * kolorP1.Green + a * kolorP3.Green) + b * (da * kolorP2.Green + a * kolorP4.Green)) * jasnosc),
                        Blue = (byte)((db * (da * kolorP1.Blue + a * kolorP3.Blue) + b * (da * kolorP2.Blue + a * kolorP4.Blue)) * jasnosc),
                    };
